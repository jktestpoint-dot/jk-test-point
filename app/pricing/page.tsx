...
export const metadata: Metadata = {
  title: "MCQ Practice Pricing",
  description: "Compare current subject-wise MCQ prices and question availability on JK Test Point.",
  alternates: { canonical: "/pricing" },
  openGraph: { title: "MCQ Practice Pricing", description: "Compare current subject-wise MCQ prices and question availability on JK Test Point.", url: "/pricing", type: "website" },
  twitter: { card: "summary", title: "MCQ Practice Pricing", description: "Compare current subject-wise MCQ prices and question availability on JK Test Point." },
};
