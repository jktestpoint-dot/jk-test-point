...
export default async function Home() {
  ...
  return <>
    ...
    <section className="container-page section-space"><div className="card overflow-hidden bg-brand-50 text-center sm:p-10"><p className="eyebrow">Simple, transparent plans</p><h2 className="mt-2 text-3xl font-bold">Start free. Upgrade when ready.</h2><p className="mx-auto mt-3 max-w-2xl text-stone-600">Premium mock tests and deeper performance insights for serious aspirants.</p><Link href="/pricing" className="btn-primary mt-6">See pricing</Link></div></section>
  </>;
}
