export type Test = { id:string; title:string; category:string; subcategory?:string; exam:string; questions:number; duration:number; price:number; difficulty:"Easy"|"Medium"|"Hard"; description:string; marks:number; negative:string };
export const tests:Test[]=[
 {id:"jkssb-01",title:"JKSSB Junior Assistant Full Mock 01",category:"JKSSB",subcategory:"Junior Assistant",exam:"Junior Assistant",questions:100,duration:120,price:0,difficulty:"Medium",description:"A full-length practice set aligned with the latest JKSSB Junior Assistant pattern.",marks:100,negative:"0.25 mark"},
 ...
 {id:"bank-01",title:"Banking Aptitude Sprint",category:"Banking",subcategory:"SBI",exam:"IBPS/SBI",questions:60,duration:60,price:49,difficulty:"Hard",description:"Time-bound quantitative and reasoning practice.",marks:60,negative:"0.25 mark"},
...
export const testCategoryGroups = [
 { name: "JKSSB", subcategories: ["Junior Assistant", "Accounts Assistant", "AHTO", "Supervisor", "JKP Constable", "JKPSI"] },
 { name: "Banking", subcategories: ["SBI", "J&K Bank"] },
 { name: "Kashmir University", subcategories: ["Junior Assistant", "Jr. Accounts Assistant", "Store Keeper"] },
 { name: "High Court", subcategories: ["Junior Assistant"] }
] as const;
