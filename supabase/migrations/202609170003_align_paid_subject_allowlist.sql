-- Align paid subject import validation with the current catalogue.
...
alter table public."SUBJECT_MCQ_QUESTIONS"
  ...
  check (subject in ('accountancy', 'mathematics', 'statistics', 'economics', 'computer', 'jk-gk', 'general-knowledge', 'reasoning', 'english', 'general-science', 'indian-polity', 'history', 'geography', 'environment', 'indian-economy'));

alter table public."SUBJECT_MCQ_ATTEMPTS"
  drop constraint if exists subject_mcq_attempts_subject_allowed_check;
alter table public."SUBJECT_MCQ_ATTEMPTS"
